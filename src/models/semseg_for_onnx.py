        ...
        for i, batch in enumerate(val_loader):
            ...
            if self.just_one:
                ...
                if net_name == 'unet2d':
                    ...
                    torch.onnx._export(self.model_base, batch['images'].cuda(), 'onnx_model_pspnet.onnx', verbose=False, opset_version=12, operator_export_type=torch.onnx.OperatorExportTypes.ONNX_ATEN_FALLBACK)
